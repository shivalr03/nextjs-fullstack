// app/add-product/page.tsx (or wherever this route lives)
...
export default async function AddProductPage() {
  ...
  // Optional: if you want to block unauth users from even seeing the form,
  // you could redirect to login here if user is null.
      ...
      <main className="ml-64 p-8">
        ...
        <div className="max-w-2xl">
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            {/* This form posts to the server action directly */}
